        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('product/product_edit_proces'); ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="product_idx" value="<?= $row_product['product_idx']; ?>">
                            <div class="row g-3">
                                <div class="col-xxl-6">
                                    <div>
                                        <label for="product_name" class="form-label">Nama Produk</label>
                                        <input type="text" class="form-control" name="product_name" value="<?= $row_product['product_name']; ?>" id="product_name" placeholder="Masukkan nama produk" required>
                                    </div>
                                </div>
                                <div class="col-xxl-6">
                                    <div>
                                        <label for="product_variant" class="form-label">Varian Produk</label>
                                        <input type="text" class="form-control" name="product_variant" value="<?= $row_product['product_variant']; ?>" id="product_variant" placeholder="Masukkan varian produk" required>
                                    </div>
                                </div>
                                <div class="col-xxl-6">
                                    <div>
                                        <label for="product_series" class="form-label">Series Produk</label>
                                        <input type="text" class="form-control" name="product_series" value="<?= $row_product['product_series']; ?>" id="product_series" placeholder="Masukkan series produk" required>
                                    </div>
                                </div>
                                <div class="col-xxl-6">
                                    <div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="product_price" value="<?= $row_product['product_price']; ?>" id="product_price" placeholder="Masukkan harga produk" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xxl-6">
                                    <div>
                                        ...
                                        <select class="form-control mb-3 select-search" name="suplier_idx" aria-label="select">
                                            ...
                                            <?php foreach ($dt_suplier as $suplier) {
                                                if ($row_product['suplier_idx'] == $suplier['suplier_idx']) { ?>
                                                    <option value="<?= $suplier['suplier_idx']; ?>" selected><?= $suplier['suplier_name']; ?> - <?= $suplier['suplier_brand']; ?></option>
                                                <?php } else { ?>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-control mb-3 select-search" name="product_type" aria-label="select">
                                            ...
                                            <?php foreach ($dt_type as $type) {
                                                if ($row_product['product_type'] == $type['product_type']) { ?>
                                                    <option value="<?= $type['product_type_id']; ?>" selected><?= $type['product_type']; ?></option>
                                                <?php } else { ?>
                                ...
                                <div class="col-xxl-6">
                                    <div>
                                        ...
                                        <textarea name="product_spec" class="ckeditor-classic"><?= base64_decode($row_product['product_spec']); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-xxl-6">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div>
                                                ...
                                                <div class="text-muted">Kosongkan jika tidak ingin mengganti gambar</div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 text-center">
                                            <img src="<?= base_url('product/product_image?idx=' . $row_product['product_idx']); ?>" class="img-fluid" alt="Product image">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xxl-6">
                                    <div>
                                        ...
                                        <select class="form-select mb-3" name="is_active" aria-label="select is_active">
                                            <option value="1" <?= ($row_product['is_active'] == 1) ? 'selected' : ''; ?>>Ya</option>
                                            <option value="0" <?= ($row_product['is_active'] == 0) ? 'selected' : ''; ?>>Tidak</option>
                                        </select>
                                    </div>
                                </div>
